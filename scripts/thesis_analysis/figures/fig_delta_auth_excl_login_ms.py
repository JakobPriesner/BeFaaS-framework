#!/usr/bin/env python3
"""Generate delta_auth_excl_login_microservices.pdf for fig:delta-auth-excl-login-ms.

Microservices: ΔAuth P99 with login vs excluding login (setUser).
"""
import sys, os
...
HW_CONFIGS = [
    (512, 0.25, 'MS S'), (1024, 0.5, 'MS M'),
    (1769, 1.0, 'MS 1769'), (2048, 1.0, 'MS L'), (8192, 4.0, 'MS XL'),
]
...
def main():
    ...
    fig.suptitle('Microservices: Auth Overhead With vs Excluding Login\n'
                 '(ΔP99, Baseline phase, excl. argon2id)', fontsize=12, fontweight='bold')
    plt.tight_layout()
    path = f"{PLOT_DIR}/delta_auth_excl_login_microservices.pdf"
