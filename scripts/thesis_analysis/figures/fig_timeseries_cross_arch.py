#!/usr/bin/env python3
"""Generate timeseries_cross_arch_cognito.pdf for fig:timeseries-cross-arch.

Cross-architecture comparison with Cognito: FaaS/512 vs MS/L vs Mono/L.
Three-panel layout: P50, P99 (log), error rate.
"""
import sys, os
...
def main():
    ...
    ax_p50.set_title('Cross-Architecture Comparison with Cognito — SCNAST Protocol',
    ...
    plt.tight_layout()
    path = f"{PLOT_DIR}/timeseries_cross_arch_cognito.pdf"
