#!/usr/bin/env python3
"""Generate timeseries_ms_l_auth_comparison.pdf for fig:timeseries-ms-auth.

MS/L (1.0 vCPU): Auth strategy comparison over SCNAST protocol.
...
def main():
    ...
    ax_p50.set_title('Microservices (L / 1.0 vCPU): Authentication Strategy Comparison',
    ...
    plt.tight_layout()
    path = f"{PLOT_DIR}/timeseries_ms_l_auth_comparison.pdf"
