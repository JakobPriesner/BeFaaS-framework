#!/usr/bin/env python3
"""Generate delta_auth_baseline_vs_flashcrowd_monolith.pdf."""
import sys, os
...
HW_CONFIGS = [(512, 0.25, 'Mono S'), (1024, 0.5, 'Mono M'),
...
def main():
    ...
    fig.suptitle('Monolith: Auth Overhead — Baseline vs Flash Crowd\n'
                 '(ΔP99, auth-only endpoints, excl. argon2id)', fontsize=12, fontweight='bold')
    plt.tight_layout()
    path = f"{PLOT_DIR}/delta_auth_baseline_vs_flashcrowd_monolith.pdf"
