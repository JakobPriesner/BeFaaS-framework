#!/usr/bin/env python3
"""Generate descriptive_stats_barplots_baseline_monolith.pdf for fig:descriptive-barplots-mono.

Bar chart: mean ± StdDev of auth-only P99 per auth strategy per HW tier.
Monolith architecture, Baseline phase only.
"""
import sys, os
...
def main():
    ...
    ax.set_title('Monolith (Fargate): Auth-only P99 (Baseline)', fontsize=13, fontweight='bold')
    ...
    plt.tight_layout()
    path = f"{PLOT_DIR}/descriptive_stats_barplots_baseline_monolith.pdf"
