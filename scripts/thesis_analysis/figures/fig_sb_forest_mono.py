#!/usr/bin/env python3
"""Generate bootstrap_ci_forest_plot_monolith.pdf for fig:sb-forest-monolith.
...
and renders a broken-axis forest plot for the Monolith architecture.
"""
import sys, os
...
ALPHA = 0.05
ARCH = 'monolith'
X_LEFT_LO, X_LEFT_HI = -50, 700
X_RIGHT_LO, X_RIGHT_HI = 1600, 8100
WR_LEFT = 3.0
...
def main():
    ...
    fig.suptitle('95%-KI: Authentifizierungs-Overhead (Monolith)',
    ...
    path = f"{PLOT_DIR}/bootstrap_ci_forest_plot_monolith.pdf"
