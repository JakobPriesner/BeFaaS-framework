#!/usr/bin/env python3
"""Generate request_queue_real_data_exp17.pdf for fig:request-queue-real.

Two-panel figure: top = arrival rate λ vs capacity cμ (with ρ>1 shading),
bottom = P95 latency (log scale). E17 (Microservices, Cognito, L, pre-calibration).
"""
import sys, os
...
def main():
    ...
    fig.suptitle(f'E{EXP_ID} (Microservices, Cognito, L, Vor-Kalibrierung)', fontsize=11, y=1.0)
    plt.tight_layout()
