#!/usr/bin/env python3
"""Generate bootstrap_ci_forest_plot_microservices.pdf for fig:sb-forest-microservices.
...
and renders a broken-axis forest plot for the Microservices architecture.
"""
import sys, os
...
ALPHA = 0.05
ARCH = 'microservices'
X_LEFT_LO, X_LEFT_HI = -50, 800
X_RIGHT_LO, X_RIGHT_HI = 2000, 26000
WR_LEFT = 3.0
...
def main():
    ...
    fig.suptitle('95%-KI: Authentifizierungs-Overhead (Microservices)',
    ...
    path = f"{PLOT_DIR}/bootstrap_ci_forest_plot_microservices.pdf"
