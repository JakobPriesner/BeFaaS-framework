#!/usr/bin/env python3
"""Generate exp_mono_table.tex for tab:exp-mono."""
import sys, os
...
STRATEGY_ORDER = [
    ...
    'Edge (Lambda@Edge)', 'Edge-Selective',
    'Manual (argon2id/EdDSA) + CF',
]
...
def main():
    df = query_df(f"""
        SELECT e.auth_strategy,
               ...
               COUNT(*) AS n
        FROM experiments e
        WHERE e.architecture = 'monolith' AND {EXCLUDE_SQL}
